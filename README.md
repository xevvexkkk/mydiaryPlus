...
<p align="center">
  一款为个人与家庭 NAS 设计的私有日记服务。数据留在自己的设备上，随时记录，也能完整导出。写这个程序的原因是作为一个社畜，时光匆匆回首总觉得淡忘了很多平淡却温馨的生活片段，又不想用微信的朋友圈，总觉得自己的生活还是放在自己的库中更踏实，看了下当前的主流项目没有特别满意的，于是就自己写了一个，基于https://github.com/aladdin0414/mydiary，
有什么问题和建议欢迎留言。
</p>
